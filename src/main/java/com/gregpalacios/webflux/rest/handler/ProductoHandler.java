package com.gregpalacios.webflux.rest.handler;
...
public class ProductoHandler {
	...
	public Mono<ServerResponse> ver(ServerRequest request) {
		...
		return productoDb.flatMap(p -> ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body(fromValue(p)))
	...
	public Mono<ServerResponse> crearConFoto(ServerRequest request) {
		Mono<Producto> producto = request.multipartData().map(multipart -> {
			...
			categoria.setNombre(categoriaNombre.value());
